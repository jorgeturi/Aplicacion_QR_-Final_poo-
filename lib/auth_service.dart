...
/*
  ...
  AuthService abstrae y centraliza la lógica necesaria para la autenticación de usuarios, facilitando la integración de Firebase y Google Sign-In en la aplicación.
*/
